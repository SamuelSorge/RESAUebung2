...
%ECHO ECS Security Console
START "Security Console" /NORMAL java SecurityConsole %1
...
START "HUMIDITY SENSOR CONSOLE" /MIN /NORMAL java DoorSensor %1
%ECHO Starting Security Controller Console
START "HUMIDITY SENSOR CONSOLE" /MIN /NORMAL java SecurityController %1
