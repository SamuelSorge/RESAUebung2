...
public class Indicator extends JFrame {
	...
	/***************************************************************************
	 * Constructor:: Indicator Purpose: This method sets up a JFrame window and
	 * drawing pane with the title specified at the position indicated by the x,
	 * y coordinates.
	 *
	 * Arguments: String Label - the indicator title Float Xpos - the vertical
	 * position of the indicator on the screen specified in terms of a
	 * percentage of the screen width. Float Ypos - the horizontal position of
	 * the indicator on the screen specified in terms of a percentage of the
	 * screen height.
	 *
	 * Returns: Indicator
	 *
	...
	public Indicator(String Label, float Xpos, float Ypos) {
		...
		/*
		 * Calculate the X and Y position of the window's upper left* hand
		 * corner as a proportion of the screen
		 */
	 ...
	 * y coordinates.
	 *
	 * Arguments: String Label - the indicator title int Xpos - the vertical
	 * position of the indicator on the screen specified in pixels. int Ypos -
	 * the horizontal position of the indicator on the screen specified in
	 * pixels.
	 *
	 * Returns: Indicator
	 *
	 ...
	 * screen height.
	 *
	 * int InitialColor - specifies the color that the indicator should be on
	 * startup.
	 *
	 * Returns: Indicator
	 *
	 ...
	 * position of the indicator on the screen specified in pixels. int Ypos -
	 * the horizontal position of the indicator on the screen specified in
	 * pixels. int InitialColor - specifies the color that the indicator should
	 * be on startup.
	 *
	 * Returns: Indicator
	 *
	...
	/***************************************************************************
	 * CONCRETE Class:: GetX Purpose: This method returns the X (vertical)
	...
	/***************************************************************************
	 * CONCRETE Class:: GetY Purpose: This method returns the Y (horizontal)
	 * position of the window in pixels
	 *
	 * Arguments: none
	 *
	...
	/***************************************************************************
	 * CONCRETE Class:: Height Purpose: This method returns the vertical height
	 * of the window
	 *
	 * Arguments: none
	 *
	...
	/***************************************************************************
	 * CONCRETE Class:: Width Purpose: This method returns the horizontal length
	 * of the window.
	 *
	 * Arguments: none
	 *
	...
	/***************************************************************************
	 * CONCRETE Class::SetLampColorAndMessage Purpose: This method will change
	 * both the indicator lamp color and the indicator label to the specified
	 * color and label. The display text is always black.
	 *
	 * Arguments: String s - the new indicator label int c - the new indicator
	 * color where 0=black, 1=green, 2=yellow, and 3=red
	 *
	 * Returns: none
	 *
	 * Exceptions: none
	...
	/***************************************************************************
	 * CONCRETE Class::SetLampColor Purpose: This method will change the
	 * indicator lamp color to the specified color.
	 *
	...
	/***************************************************************************
	 * CONCRETE Class::SetMessage Purpose: This method will change both the
	 * indicator label to the specified label string. The display text is always
	 * black.
	 *
	...
	/***************************************************************************
	 * CONCRETE Class::paint Purpose: The paint() method is an overridden method
	...
	public void paint(Graphics g) {
		...
		int xLabelPosition = (int) (Height * 0.5)
				- (int) (fm.stringWidth(MessageLabel) * 0.5);
		int yLabelPosition = (int) (Height * 0.90);
		g.setColor(IluminationColor);
		g.fillRoundRect((int) (Height * 0.15), (int) (Height * 0.35),
				(int) (Height * 0.70), (int) (Height * 0.40),
				(int) (Height * 0.20), (int) (Height * 0.20));
