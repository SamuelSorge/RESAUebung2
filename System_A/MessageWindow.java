...
public class MessageWindow {
	...
	private int UpperLeftX; // The default window's upper left hand corner's X
							// position
	private int UpperLeftY; // The default window's upper left hand corner's Y
							// position
	private JFrame MessageWindow; // Message window frame
	private JTextArea MessageArea; // This is the message area widget

	/***************************************************************************
	 * Constructor:: MessageWindow Purpose: This method sets up the JFrame
	 * window with the title specified at the position indicated by the x, y
	 * coordinates
	 *
	 * Arguments: String Title - the window title Float Xpos - the vertical
	 * position of the window on the screen specified in percentage of the total
	 * screen width. Float Ypos - the horizontal position of the window on the
	...
	public MessageWindow(String Title, float Xpos, float Ypos) {
		...
		/*
		 * Make window height 25% of the screen height and* the window width 50%
		 * of the screen width
		 */
		...
		MessageWindow.setBounds(UpperLeftX, UpperLeftY, WindowWidth,
				WindowHeight);
		MessageWindow
		...
		MessageArea = new JTextArea((int) (WindowHeight / 20),
				(int) (WindowWidth / 12));
	 ...
	 * coordinates
	 *
	 * Arguments: String Title - the window title int Xpos - the vertical
	 * position of the window on the screen specified in pixels. int Ypos - the
	 * horizontal position of the window on the screen specified in pixels.
	 *
	 * Returns: MessageWindow
	 *
	 * Exceptions: none
	...
	/***************************************************************************
	 * CONCRETE Class:: TermHeight Purpose: This method returns the vertical
	...
	/***************************************************************************
	 * CONCRETE Class:: TermWidth Purpose: This method returns the horizontal
	...
	/***************************************************************************
	 * CONCRETE Class:: WriteMessage Purpose: This method writes a message to
	 * the text area. All messages are written with a date stamp and all strings
