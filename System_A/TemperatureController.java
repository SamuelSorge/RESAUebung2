	...
	public static void main(String args[]) {
		...
		if (em != null) {
			...
			MessageWindow mw = new MessageWindow(
					"Temperature Controller Status Console", WinPosX, WinPosY);

			// Put the status indicators under the panel...

			Indicator ci = new Indicator("Chiller OFF", mw.GetX(), mw.GetY()
					+ mw.Height());
			Indicator hi = new Indicator("Heater OFF", mw.GetX()
					+ (ci.Width() * 2), mw.GetY() + mw.Height());
